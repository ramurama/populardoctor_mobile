...
class FooterFrontDesk extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  _renderScheduleButton() {
    return (
      <Button
        ...
        onPress={() =>
          this.props.navigation.navigate(VIEW_FD_SCHEDULE, {
            title: DR_SCHEDULE
          })
        }
      >
  ...
  _renderCurrentBookingsButton() {
    return (
      <Button
        ...
        onPress={() =>
          this.props.navigation.navigate(VIEW_FD_CURRENT_BOOKINGS, {
  ...
  _renderVisitConfirmationButton() {
    return (
      <Button
        ...
        onPress={() => this.props.navigation.navigate(VIEW_NAV_FD_QR)}
      >
        <Icon
          name="ticket"
          type="Foundation"
...
export default FooterFrontDesk;
